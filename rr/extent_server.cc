...
int extent_server::setattr(extent_protocol::extentid_t id, extent_protocol::attr attributes, int& r)
{
  fileMutex.lock();

  fileContents_[id].first.size = attributes.size;
  fileContents_[id].first.atime = attributes.atime;
  fileContents_[id].first.mtime = attributes.mtime;
  fileContents_[id].first.ctime = attributes.ctime;
